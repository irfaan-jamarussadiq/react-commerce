                ...
                <div class="gallery">
                    ...
                    <div className="gallery-item">
                        <figure class="gallery__item gallery__item--2">
                            <img src="images/small-table.jpg" class="gallery__img" alt="Image 2" />
                        </figure>
                        <div className="product-name-container">
                            <h3 className="product-name">Small Study Table</h3>
                        </div>

                        <div className="product-price-container">
                            <h3 className="product-price">$19.99</h3>
                        </div>
                    </div>
                    <div className="gallery-item">
                        <figure class="gallery__item gallery__item--3">
                            <img src="images/sofa.jpg" class="gallery__img" alt="Image 3" />
                        </figure>
                        <div className="product-name-container">
                            <h3 className="product-name">Medium Size Sofa</h3>
                        </div>

                        <div className="product-price-container">
                            <h3 className="product-price">$250.99</h3>
                        </div>
                    </div>
                    <div className="gallery-item">
                    ...
                    <div className="gallery-item">
                        <figure class="gallery__item gallery__item--3">
                            <img src="images/work-desk.jpg" class="gallery__img" alt="Image 3" />
                        </figure>
                        <div className="product-name-container">
                            <h3 className="product-name">Work Desk</h3>
                        </div>
                    ...
                    <div className="gallery-item">
                        <figure class="gallery__item gallery__item--3">
                            <img src="images/sofa2.jpg" class="gallery__img" alt="Image 3" />
                        </figure>
                        <div className="product-name-container">
                            <h3 className="product-name">5 Seat Sofa</h3>
                        </div>

                        <div className="product-price-container">
                            <h3 className="product-price">$450.99</h3>
                        </div>
                    </div>
                </div>
            </div>
